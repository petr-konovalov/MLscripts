function [first_rul, second_rul, third_rul] = STPGame3by3FirstCom(ball, BPosHX, BPosHY, ballFastMoving, ballSaveDir, own, opp, ownG, oppG, ownV, oppV, ballInside, obstacles)
